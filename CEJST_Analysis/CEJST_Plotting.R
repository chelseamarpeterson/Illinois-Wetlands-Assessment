...
# plot posterior line
area.df.sf = area.cj.df.unprotected[which(area.cj.df.unprotected$water_cutoff == "Seasonally Flooded"),]
line.df.sf = post.line.df[which(post.line.df$water_cutoff == "Seasonally Flooded"),]
p2 = ggplot() + 
